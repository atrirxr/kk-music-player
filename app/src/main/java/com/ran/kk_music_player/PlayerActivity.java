...
import com.ran.kk_music_player.databinding.ActivityPlayerBinding;
...
public class PlayerActivity extends AppCompatActivity {
        ...
        Futures.addCallback(controllerFuture, new FutureCallback<MediaController>() {
            ...
            public void onSuccess(MediaController controller) {
                    ...
                    public void onMediaItemTransition(MediaItem mediaItem, int reason) {
                        if (mediaItem != null) {
                            ...
                            if (index >= 0 && index < songList.size()) {
                                ...
                                store.currentSong = songList.get(index);
                                updateUI(store.currentSong);
                            }
                        }
                    }
                ...
                if (playImmediately) {
                    ...
                    for (Song s : songList) {
                        items.add(MediaItem.fromUri(s.data));
                    }
                    mediaController.setMediaItems(items, currentIndex, 0);
                    mediaController.setShuffleModeEnabled(store.isShuffle);
    ...
    private void setupControls() {
        ...
        binding.buttonSequential.setOnClickListener(v -> toggleSequential());
    ...
    private void updateModeIcons() {
        binding.buttonSequential.setImageResource(
                store.isSequential ? R.drawable.ic_sequential_on_24 : R.drawable.ic_sequential_24
        );
        binding.buttonShuffle.setImageResource(
                store.isShuffle ? R.drawable.ic_shuffle_on_24 : R.drawable.ic_shuffle_24
        );
    }
